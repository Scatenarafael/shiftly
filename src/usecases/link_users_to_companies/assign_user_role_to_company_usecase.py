...
class AssignUserRoleToCompanyUseCase:
    ...
    async def execute(self, user_id: str, company_id: str, role_id: str) -> Awaitable[Optional[Company]]:
        return await self.user_role_company_repository.assign_user_and_role_to_company(user_id=user_id, company_id=company_id, role_id=role_id)
