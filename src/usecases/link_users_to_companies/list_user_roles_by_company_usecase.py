...
class ListUserAndRolesByCompanyUseCase:
    ...
    async def execute(self, company_id: str) -> list[UsersRolesFromCompany]:
        return await self.user_role_company_repository.list_users_and_roles_by_company(company_id=company_id)
